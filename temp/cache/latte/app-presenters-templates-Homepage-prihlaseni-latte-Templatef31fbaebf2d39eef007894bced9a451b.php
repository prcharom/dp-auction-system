<?php
// source: C:\Users\prcharom\Desktop\EasyPHP-DevServer-14.1VC9\data\localweb\dp-auction-system\app\presenters/templates/Homepage/prihlaseni.latte

class Templatef31fbaebf2d39eef007894bced9a451b extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('ab907c9e68', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbeb33a32ea1_content')) { function _lbeb33a32ea1_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb61798c497c_head')) { function _lb61798c497c_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
div.mar-input {
    margin-bottom: 1em;
}
