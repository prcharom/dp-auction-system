<?php
// source: C:\Users\prcharom\Desktop\EasyPHP-DevServer-14.1VC9\data\localweb\dp-auction-system\app\presenters/templates/Admin/../@layout-modal.latte

class Templatea07838c59fea814d6eca7910ce111597 extends Latte\Template {
function render() {
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbe0c4c9a214_head')) { function _lbe0c4c9a214_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb43d35ddcb9_scripts')) { function _lb43d35ddcb9_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>	<!-- jQuery -->
