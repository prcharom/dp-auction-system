...
?>	<script src="//code.jquery.com/jquery-1.11.3.min.js"></script>
	...
	<script src="<?php echo Latte\Runtime\Filters::escapeHtml(Latte\Runtime\Filters::safeUrl($basePath), ENT_COMPAT) ?>/assets/js/custom.js"></script>
<?php
}}
...
<head>
 ...
 | <?php } ?>Aukční systém</title>
    ...
    <![endif]-->
    <link href="<?php echo Latte\Runtime\Filters::escapeHtml(Latte\Runtime\Filters::safeUrl($basePath), ENT_COMPAT) ?>/assets/css/font-awesome.min.css" rel="stylesheet">
    <link href="<?php echo Latte\Runtime\Filters::escapeHtml(Latte\Runtime\Filters::safeUrl($basePath), ENT_COMPAT) ?>/assets/css/custom.css" rel="stylesheet">
