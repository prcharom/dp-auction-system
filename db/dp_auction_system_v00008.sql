...
--
-- Počítač: 127.0.0.1
-- Vytvořeno: Pát 26. úno 2016, 00:03
...
(1, 6, 1, '2016-02-25 21:37:09', 0, 'O aukci neměl nikdo zájem. A další slova, co nikoho nezajímají. Bla bla bla tadadada.');
...
(7, 6, 6, '2016-02-11 18:56:46', 0),
(9, 4, 1, '2016-02-20 22:20:20', 0),
(10, 42, 6, '2016-02-21 13:55:48', 5),
(11, 42, 6, '2016-02-21 13:56:33', 5),
(12, 6, 4, '2016-02-03 00:00:00', 5);
...
INSERT INTO `product` (`id`, `id_user`, `id_category`, `id_type_auction`, `name`, `description`, `cost`, `added`, `expire`) VALUES
(3, 1, 2, 1, 'Škoda Octavia RS', 'Jedná se o moderní automobil vyrobený v Mladé Boleslavi. Tato nová Škoda Octavia má samé klady. Škodováci si určitě zamilují novou poloautomatickou spojku, kterou se automobilka rozhodla nově zařadit do sériové výroby tohoto vozu. Toto vozítko vás prostě dostane, ne náhodou se řadí k největším aspirantům na titul auto roku 2015.', 1100000, '2015-12-16 16:03:17', '2016-02-29 16:45:41'),
(4, 6, 3, 2, 'Kožená sedačka', 'Téměř nová sedačka za solidní peníz. Kdo nekoupí, ten jednoznačně prohloupí. ', 3200, '2015-12-21 22:17:57', '2016-02-20 22:20:20'),
(5, 1, 4, 1, 'Model Punťa', 'Ideální na mazlení do každé rodiny. Model je přítulný a zdravotně nezávadný. Obdarujte jím své blízké ještě dnes.', 1250, '2016-01-05 22:29:07', '2016-04-06 22:00:00'),
(6, 1, 6, 2, 'Byt 3+1', 'Byt v klidné oblasti. Původní majitelka po drogovém večírku vyskočila z okna. Byt je tedy volný a případnému zájemci ihned k dispozici.', 750000, '2016-01-05 22:37:19', '2016-02-11 18:56:46'),
(42, 1, 4, 2, 'Přepravka jablek', 'Zboží je dodáváno v dřevěných přepravkách.', 150, '2016-02-02 23:15:00', '2016-04-05 23:00:00');
...
(1, 1, 1, 'prcharom', '$2a$07$46uhodvkzf8aews8dettqOzK6hqSnbVIx9map9AsMI7o9gCVKdeXW', 'Folknáře 32 Děčín 28', 'Roman Prchal', 'prcharom@gmail.com', '702297294', '2016-02-25 22:32:39', '2015-12-04 23:21:37', 'g6otud41piz71vl86fr0zayfma416mfkozkmtcaux58cupflio8k1wk934z4.gif'),
...
(6, 2, 2, 'jira', '$2a$07$4rh68op6dnykabfi5vjeseladqyGaNvCKMFk5sIXxJleLaZAaufBm', 'Folknare 32 Decin 28', 'Jirina Prchalova', 'nema@seznam.cz', '541036', '2016-02-25 22:38:35', '2016-02-11 18:55:33', NULL);
